...
3. **In Coolify, set the Docker Compose File to `docker-compose.build.yml` (not the default `docker-compose.yml`).** This file contains the `build: context: .` directive that builds your fork from source.
